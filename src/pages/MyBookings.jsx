    ...
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
     ...
     <div className='max-w-6xl mt-8 w-full text-gray-800'>
      ...
      {bookings.map((booking)=>(
        <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] items-center w-full border-b border-gray-300 py-6 first:border-t'>

          {/*Hotel Details*/}
          <div className='flex flex-col md:flex-row'>
<img src={booking.room.images[0]} alt="hotel-img"
     className='w-44 h-28 rounded shadow object-cover md:mr-4 mb-2 md:mb-0' />
  ...
  <div className='flex flex-row justify-center items-center gap-12 text-sm text-gray-700 text-center'>
