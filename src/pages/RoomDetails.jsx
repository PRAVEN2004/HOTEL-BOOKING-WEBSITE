...
const RoomDetails = () => {
  ...
  return room && (
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/*room address*/}
      <div className='flex items-center gap-1 text-grayu-500 mt-2'>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability.
          ...
          get the exact price for groups. The Guests will be allocated ground floor 
          according t0 availability. You get the comfortable two  bedroom 
