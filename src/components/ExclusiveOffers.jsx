...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-16
    lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center
        justify-between w-full'>
      <Title align='left' title='Exclusive Offers' subTitle='Take aadvantage of our limited-time offers and special packages to enhance your stay 
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
        {exclusiveOffers.map((item)=>(
            ...
            justify-betweengap-1 pt-12 md:pt-18 px-4 rounded-xl text-white
            ...
            image})`}}>
                ...
                <div>
                    <p className='text-2cl font-medium font-playfair'>{item.title}</p>
